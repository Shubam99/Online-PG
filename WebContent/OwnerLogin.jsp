	...
	<div class="d-flex justify-content-center h-100" style="margin-top: 150px">
		<div class="card">
			<div class="card-header bg-primary text-white" align="center">
				<h3 style="font-family: arial; justify-content: center; ">Owner Login</h3>
			</div>
			<div class="card-body">
				<form action="OwnerLoginServlet" method="post">
					<div class="input-group form-group">
						...
						<input type="email" name="owneremail" autofocus required class="form-control" placeholder="E-mail">
					...
					<div class="input-group form-group">
						...
						<input type="password" name="ownerpassword" required class="form-control" placeholder="Password">
					</div>
			...
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="OwnerRegisteration.jsp">Sign Up</a>
				</div>
